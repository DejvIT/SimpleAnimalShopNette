<?php
// source: /Users/davidpavlicko/Documents/PhpStorm/pet-store-nette/config/common.neon
// source: /Users/davidpavlicko/Documents/PhpStorm/pet-store-nette/config/services.neon
// source: array
...
class Container_a188aae0d0 extends Nette\DI\Container
{
	...
	protected array $wiring = [
		...
		'App\UI\Animal\AnimalPresenter' => [2 => ['application.2']],
	...
	public function createService02(): App\Model\AnimalManager
	{
		return new App\Model\AnimalManager('/Users/davidpavlicko/Documents/PhpStorm/pet-store-nette/app/data/animals.xml');
	}
	...
	public function createServiceApplication__2(): App\UI\Animal\AnimalPresenter
	{
		$service = new App\UI\Animal\AnimalPresenter($this->getService('02'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'/Users/davidpavlicko/Documents/PhpStorm/pet-store-nette/temp/cache/nette.application/touch',
		));
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('/Users/davidpavlicko/Documents/PhpStorm/pet-store-nette/temp/cache/journal.s3db');
	}
	...
	public function createServiceCache__storage(): Nette\Caching\Storage
	{
		return new Nette\Caching\Storages\FileStorage(
			'/Users/davidpavlicko/Documents/PhpStorm/pet-store-nette/temp/cache',
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_a188aae0d0 $container,
			) {
			}
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('/Users/davidpavlicko/Documents/PhpStorm/pet-store-nette/temp/cache/latte');
